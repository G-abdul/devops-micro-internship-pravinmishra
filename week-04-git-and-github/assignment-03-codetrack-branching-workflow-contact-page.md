...
![Screenshot-1](./screenshots/git-status-and-git-branch.png)
...
![Screenshot-2](./screenshots/git-checkout-git-branch.png)
...
![Screenshot-3](./screenshots/ls-showing-contact-html.png)

---

#### Screenshot 4 — Output of `git commit`

![Screenshot-4](./screenshots/Screenshot-4-git-commit.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Screenshot-5](./screenshots/git-log-oneline-3.png)
...
![Screenshot-6](./screenshots/Screenshot-6-git-status-modified.png)

---

#### Screenshot 7 — Output of `git commit`

![Screenshot-7](./screenshots/git-commit-Contact-Page-link.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Screenshot-8](./screenshots/no-contact-page-link.png)
...
![Screenshot-9](./screenshots/Screenshot-9-ls-contact-html-absent.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![Screenshot-10](./screenshots/no-contact-page-link.png)
...
![Screenshot-11](./screenshots/Screenshot-11-git-merge-feature-contact-page.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Screenshot-12](./screenshots/ls-contact-html-after-merge.png)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Screenshot-13](./screenshots/Screenshot-13-Browser-showing-Contact-page.png)
...
![Screenshot-14](./screenshots/gitlog-oneline-graph-decorate-all.png)
...
![Screenshot-15](./screenshots/feature-contact-page-deleted.png)
