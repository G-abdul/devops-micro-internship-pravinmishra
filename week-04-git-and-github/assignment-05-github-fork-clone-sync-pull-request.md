...
![Screenshot-1](./screenshots/fork-page-devops-micro-internship-interviews.png)
...
![Screenshot-2](./screenshots/Screenshot-2-git-config-global-get-credential-helper.png)
...
![Screenshot-](./screenshots/git-remote-v-showing-your-fork-and-upstream-ravinmishraaws.png)
...
![Screenshot-4](./screenshots/Screenshot-4-git-status-pull_request-modified.png)

---

#### Screenshot 5 — Output of `git commit`

![Screenshot-5](./screenshots/Screenshot-5-git-commit.png)
...
![Screenshot-6](./screenshots/git-push-origin-feature-readme-update-successful.png)

---

#### Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner

![Screenshot-7](./screenshots/GitHub-feature-readme-update.png)
...
![Screenshot-8](./screenshots/Pull-Request-creation-page.png)
...
`https://www.linkedin.com/posts/abdulganiyu0_git-github-opensource-share-7486543929321123841-OFO9/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFamVAYBbC0P-4_t5y56JbVGUfZFmuyqJnY`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![Screenshot](./screenshots/Linkedin-Pull-Request.png) ![Screenshot](./screenshots/Linkedin-Pull-Request-2.png)
...
`https://github.com/G-abdul/devops-micro-internship-interviews.git`
