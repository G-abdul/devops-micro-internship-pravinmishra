...
![Screenshot-1](./screenshots/Sprint-1-created-with-Story-inside.png)

---

#### Screenshot 2 — Active Sprint board showing the Sprint Goal

![Screenshot-2](./screenshots/Active-Sprint-board-showing-Sprint-Goal.png)
...
![Screenshot-2](./screenshots/Day-1-Sub-task-Done.png)

---

#### Screenshot 4 — Successful Git commit output

![Screenshot-2](./screenshots/Successful-Git-commit-output.png)

---

#### Screenshot 5 — EC2 browser view showing the complete footer text, with the URL visible

![Screenshot-2](./screenshots/EC2-browser-showing-complete-footer-text.png)

---

#### Screenshot 6 — Jira Story comment showing the Day 1 Daily Scrum update

![Screenshot-2](./screenshots/Day-1-Daily-Scrum-update.png)
...
![Screenshot-2](./screenshots/Code-editor-showing-the-footer-and-date-logic.png)

---

#### Screenshot 8 — EC2 browser view showing the updated footer with the current date

![Screenshot-2](./screenshots/EC2-browser-view-showing-the-updated-footer.png)

---

#### Screenshot 9 — README snippet documenting the footer and date behavior

![Screenshot-2](./screenshots/README-snippet-documenting-footer-&-date-behavior.png)

---

#### Screenshot 10 — Jira Story comment showing the Day 2 Daily Scrum update

![Screenshot-2](./screenshots/Jira-Story-comment-Day-2-Daily-Scrum-update.png)
...
![Screenshot-2](./screenshots/EC2-showing-polished-footer.png)

---

#### Screenshot 12 — Mobile responsive view showing the footer remains readable

![Screenshot-2](./screenshots/Mobile-view-shooter-footer.png)

---

#### Screenshot 13 — Jira Story comment showing the Day 3 Daily Scrum update

![Screenshot-2](./screenshots/Jira-Story-comment-Day-3.png)
...
![Screenshot-2](./screenshots/EC2-showing-Start-your-DevOps-Journey-here.png)
...
![Screenshot-2](./screenshots/Burndown-Chart-for-Sprint-1.png)

---

#### Screenshot 16 — Jira retrospective comment

![Screenshot-2](./screenshots/Jira-retrospective-comment.png)

---

#### Screenshot 17 — Final EC2 browser view showing the complete footer requirement

![Screenshot-2](./screenshots/Final-EC2-showing-complete-footer-requirement.png)
---
