...
![Screenshot-1](./screenshots/claude-folder-structure.png)
...
![Screenshot-2](./screenshots/user-prompt-guard-sh.png)
...
![Screenshot-3](./screenshots/pre-tool-guard-sh.png)
...
![Screenshot-4](./screenshots/post-tool-guard-sh.png)
...
![Screenshot-5](./screenshots/settings-json.png)
...
![Screenshot-6](./screenshots/UserPromptSubmit-hook.png)
...
![Screenshot-7](./screenshots/pre-tool-hook.png)
...
![Screenshot-8](./screenshots/terraform-validate.png)

#### Screenshot 9 — `.claude/deploy.log` showing the logged command

![Screenshot-9](./screenshots/deploy-log.png)
